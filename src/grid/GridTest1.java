...
public class GridTest1 {
	 ...
	 * Node URL (ff+chrome)
	 * java -Dwebdriver.chrome.driver="D:\Training\TrainingContent\SeleniumJars_Software\chromedriver_win32_B39\chromedriver.exe" -Dwebdriver.gecko.driver="D:\Training\TrainingContent\SeleniumJars_Software\geckodriver_64\geckodriver.exe" -jar selenium-server-standalone-3.5.2.jar -role node -hub http://192.168.0.187:4444/grid/register/ -browser "browserName=firefox,version=ANY,platform=WINDOWS,maxInstances=5" -browser "browserName=chrome,version=ANY,platform=WINDOWS,maxInstances=5" -maxSession 5
	 * 
